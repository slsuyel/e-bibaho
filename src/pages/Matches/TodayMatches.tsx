...
const TodayMatches = () => {
  ...
  return (
    <div className="container font-maven card my-5">
      ...
      <div className="align-items-center d-flex gap-3 justify-content-end mt-4 text-end">
        ...
        <div>
          <Button type="primary" className="m-1" onClick={goToPrevious}>
            Previous
          </Button>
          <Button type="primary" className="m-1" onClick={goToNext}>
            Next
          </Button>
        </div>
      </div>
      ...
      <div className="m-4">
        {resultCards.length > 0 && <ResultCard key={currentIndex} />}
      </div>
    </div>
  );
};
