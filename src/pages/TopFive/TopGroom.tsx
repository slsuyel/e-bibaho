...
import img from "../../assets/images/dr-boy.png";
  ...
  return (
    <div className="row">
      <div className="col-md-3">
        <h1 className="font-maven text-center mb-3 position-sticky top-0 z-index-1000">
          Our Top
          <span className="fw-medium text-info-emphasis"> Groom </span>
        </h1>
      </div>

      <div className="top_five_container col-md-9">
